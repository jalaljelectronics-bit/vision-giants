...
export default function TestimonialFormModal({
  ...
  function updateField<
    K extends keyof TestimonialFormState
  >(
    key: K,
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const res = isEditing
        ? await adminApi.put<Testimonial>(
            `/testimonials/${testimonial!.id}`,
            payload
          )
        : await adminApi.post<Testimonial>(
            '/testimonials',
            payload
          );
      ...
      setError(
        'Could not save testimonial. Check the fields and try again.'
      );
    } finally {
      setIsSaving(false);
    }
